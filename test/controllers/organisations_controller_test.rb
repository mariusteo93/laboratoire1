...
class OrganisationsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create organisation" do
    assert_difference('Organisation.count') do
      post organisations_url, params: { organisation: { Adresse: @organisation.Adresse, Courriel: @organisation.Courriel, Fax: @organisation.Fax, Nom: @organisation.Nom, Telephone: @organisation.Telephone } }
    end
  ...
  test "should update organisation" do
    patch organisation_url(@organisation), params: { organisation: { Adresse: @organisation.Adresse, Courriel: @organisation.Courriel, Fax: @organisation.Fax, Nom: @organisation.Nom, Telephone: @organisation.Telephone } }
